...
const pagesRoutes: Routes = [
    {
        ...
        children:[
            ...
            { path: 'waltDisney/:id', component: WaltDisneyStudiosDetailComponent, data: { tittle: 'WaltDisneyTitleDetail' }},
            { path: 'waltDisneyTitles', component: WaltDisneyStudiosComponent, data: { tittle: 'WaltDisneyTitles' }},
            { path: 'incident/:id', component: IncidentDetailComponent, data: { tittle: 'IncidentDetail' }},
